...
echo "find ${INDEX}/*.fasta -type f | parallel -I% --tag --max-args 1 -P ${BLAST_THREADS} ./parallel_index.sh -a bwtsw -b 100000000 -f % -c ${CONFIG}"
find ${INDEX}/*.fasta -type f | parallel -I% --tag --max-args 1 -P ${BLAST_THREADS} ./parallel_index.sh -a bwtsw -b 100000000 -f % -c ${CONFIG}